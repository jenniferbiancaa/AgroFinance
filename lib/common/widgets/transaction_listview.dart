...
Widget build(BuildContext context) {
  initializeDateFormatting('pt_BR', null); // Inicializa as configurações de localização para o português brasileiro
            ...
            child: Row(
              ...
              children: [
                ...
                TabBar(
                  ...
                  tabs: [
                    Tab(
                      text: DateFormat.yMMMM('pt_BR').format(_currentMonth), // Utiliza o formato de mês por extenso com a localização para o português brasileiro
                    ),
                  ],
                ),
                  IconButton(
              ...
              return Dismissible(
                ...
                confirmDismiss: (direction) async {
                  confirmDelete = await showCustomModalBottomSheet(
                    context: context,
                    content: 'Confirmar exclusão desta conta?',
                    actions: [
                      Flexible(
                        child: PrimaryButton(
                          text: 'Cancelar',
